...
- If the user says "continue the work" and multiple tasks are active without a binding, ask which task id â€” do not silently attach to an arbitrary task.
