...
import { findWorkspaceRoot, resolveWorktreeRoot, pathsFor as workspacePathsFor } from "../adapters/shared/concurrency/paths.mjs";
...
import { setTaskTarget, readTask, listTasks } from "../adapters/shared/concurrency/task.mjs";
