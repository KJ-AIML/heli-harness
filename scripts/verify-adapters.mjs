...
const riskyPatterns = [
	...
	{ pattern: /(?<!no\s)(?<!not\s)opencode\s+adapter(?!\s+implementation)/i, claim: "OpenCode adapter (positive claim)", requiredStatus: ["enforced", "verified-plugin-wired", "plugin-wired", "verified-wired", "wired", "documented"] },
	{ pattern: /grok\s+enforced/i, claim: "Grok enforced", requiredStatus: ["enforced"] },
	{ pattern: /opencode\s+enforced/i, claim: "OpenCode enforced", requiredStatus: ["enforced"] },
	{ pattern: /kimi\s+enforced/i, claim: "Kimi enforced", requiredStatus: ["enforced"] },
	{ pattern: /antigravity\s+enforced/i, claim: "Antigravity enforced", requiredStatus: ["enforced"] },
