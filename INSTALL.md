...
Pin a release when needed: `npx github:KJ-AIML/heli-harness#v0.8.3 install <path>`.
...
### Clean install semantics (v0.8.3+)
...
```bash
pi install git:github.com/KJ-AIML/heli-harness@v0.8.3
axga install git:github.com/KJ-AIML/heli-harness@v0.8.3
```
