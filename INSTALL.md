...
Pin a release when needed: `npx github:KJ-AIML/heli-harness#v0.7.2 install <path>`.
...
### Clean install semantics (v0.7.2+)
...
```bash
pi install git:github.com/KJ-AIML/heli-harness@v0.7.2
axga install git:github.com/KJ-AIML/heli-harness@v0.7.2
```
