...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img alt="Version" src="https://img.shields.io/badge/version-0.5.14-informational"></a>
...
Use the latest stable tag (v0.5.14). Do not install globally. Treat the current
...
```bash
pi install git:github.com/KJ-AIML/heli-harness@v0.5.14
axga install git:github.com/KJ-AIML/heli-harness@v0.5.14
```
