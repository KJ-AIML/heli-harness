...
## Current Baseline: v0.8.3

Latest stable release: `v0.8.3`
...
- Maintain the `v0.8.3` Root-Cause Convergence and Evidence-Gated Autonomy release; keep release claims aligned with the changelog and adapter support matrix.
