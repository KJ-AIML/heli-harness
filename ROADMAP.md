...
## Current Baseline: v0.7.3

Latest stable release: `v0.7.3`
...
- Maintain the `v0.7.3` Concurrent Session Foundation baseline and keep release claims aligned with the changelog and adapter support matrix.
