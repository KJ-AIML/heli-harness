...
- Maintain the `v0.8.1` Root-Cause Convergence and Evidence-Gated Autonomy release; keep release claims aligned with the changelog and adapter support matrix.
