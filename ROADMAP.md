...
## Current Baseline: v0.5.24

Latest stable release: `v0.5.24`
...
- Maintain the `v0.5.24` Concurrent Session Foundation baseline and keep release claims aligned with the changelog and adapter support matrix.
