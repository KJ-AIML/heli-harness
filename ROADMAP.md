...
- Maintain the `v0.8.2` Root-Cause Convergence and Evidence-Gated Autonomy release; keep release claims aligned with the changelog and adapter support matrix.
