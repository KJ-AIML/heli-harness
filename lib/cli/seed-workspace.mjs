...
export const FRESH_SCHEMA = {
	...
	mode: "concurrent",
	updatedAt: null,
	note: "fresh install defaults to concurrent; create/claim tasks for multi-agent isolation. Zero tasks = single-agent bootstrap (writes allowed until first task exists).",
};
