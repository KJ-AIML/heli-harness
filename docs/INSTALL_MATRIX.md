...
| --- | --- | --- |
| Pi / AXGA | `pi install git:github.com/KJ-AIML/heli-harness@v0.5.27` or `axga install git:github.com/KJ-AIML/heli-harness@v0.5.27` | Package install; run `/heli-install` for a workspace harness |
