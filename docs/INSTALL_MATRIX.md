...
| --- | --- | --- |
| Pi / AXGA | `pi install git:github.com/KJ-AIML/heli-harness@v0.8.2` or `axga install git:github.com/KJ-AIML/heli-harness@v0.8.2` | Package install; run `/heli-install` for a workspace harness |
