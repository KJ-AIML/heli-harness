...
| Step | Command | Result |
| --- | --- | --- |
| Install pinned release | `npm install -g github:KJ-AIML/heli-harness#v0.10.3` | Shared/global Heli CLI/runtime |
...
```bash
npx github:KJ-AIML/heli-harness#v0.10.3 install <path>
```
